...
Consult the documentation of the [`future`-package on CRAN](https://CRAN.R-project.org/package=future) for more information about this framework and its supported computation plans.
