...
The R-package `incubate` employs an alternative estimation method called *maximum product of spacings estimation (MPSE)* to estimate delay and other parameters in a one or two group setting.
Building on MPSE, `incubate` can

1. calculate bootstrap confidence intervals for these model parameters _and_
