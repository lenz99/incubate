...
$$
x := - \frac{1}{π} · \exp(-\frac{1}{π}) = -\frac{1-πt}{π} · \exp(-\frac{1-πt}{π})
$$
...
t_0 = \frac{1}{π} + W_0(x)
$$
Substituting the original expression for $t$, we get $Z = α + \frac{1}{λ} · (\frac{1}{π} + W_0(x))$.
...
Therefore, the actual proportion of right censorings in a generated sample will fluctuate around the expected proportion π.

‼️ For Weibull distributions, there is still a **bug** with the CDF of the censoring process, as we do not account that the CDF is limited upwards by 1.
